# Ballerina Oraclefusion.erp.integrations connector
...
The `Oraclefusion.erp.integrations` connector provides practical examples illustrating usage in various scenarios. Explore these [examples](https://github.com/module-ballerinax-oraclefusion.erp.integrations/tree/main/examples/), covering the following use cases:
